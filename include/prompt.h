...
int ptr_handle_shell_var(shell_t *shell);
int ptr_handle_env_var(shell_t *shell);
int ptr_bold(shell_t *shell);
int ptr_underline(shell_t *shell);
int ptr_foreground(shell_t *shell);
int ptr_background(shell_t *shell);

static const struct {
	char token;
	int (*handler)(shell_t *shell);
} prompt[] = {
        {'%', &ptr_modulo},
        {'m', &ptr_handle_host},
        {'u', &ptr_handle_user},
